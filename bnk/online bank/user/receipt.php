                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-3"><?php echo "$".$receipt_row['amount']; ?></td>
                        </tr>
                        <tr>
                            <td class="text-right">
                            <p>
                            ...
                            <td>
                            <p>
                                <strong><?php echo "$".($receipt_row['amount']+$receipt_row['amount']*0.001); ?></strong>
                            </p>
                            <p>
                                <strong><?php echo "$".$receipt_row['amount']*0.001; ?></strong>
                            </p>
							<p>
                        ...
                        <tr>
                            ...
                            <td class="text-left text-danger"><h2><strong><?php echo "$".($receipt_row['amount']+$receipt_row['amount']*0.001); ?></strong></h2></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-left text-success"><h2><strong><?php echo "$".($receipt_row['amount']-$receipt_row['amount']*0.001); ?></strong></h2></td>
                        </tr>
                    </tbody>
                </table>
            </div>
